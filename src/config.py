...
class StreamingConfig(BaseModel):
    ...
    # before we start deferring fallback for the greeting. After this, a 3-second grace period allows
    # buffering to continue. Asterisk 22 with Strict RTP may take 4-6+ seconds for external calls.
    greeting_rtp_wait_ms: int = Field(default=2000)
